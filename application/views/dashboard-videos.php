                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="content">
                            <div class='row'>
                                <div class="col-md-12">
                                    <a href="<?= base_url()?>cp/new_video"><button type="submit" class="btn btn-success btn-fill btn-lg center-block"><i class="pe-7s-plus"></i> New Video</button></a>
                                </div>
                            </div>
                            <h4> <a id="bloglist">Videos </a> </h4>
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <table id="tableblog" class="display table" width="100%">
                                            ...
                                            <?php
                                                for ($i = 0; $i < sizeof($videos); $i++) {
                                                	$status = ($videos[$i]['status'] == "1") ? "<p class='ok'>Active</p>" : "<p class='no'>Unactive</p>" ;
                                                	echo "<tr>";
                                                	echo "<td>" .  $videos[$i]['video_id'] . "</td>";
                                                	echo "<td>" .  $videos[$i]['title'] . "</td>";
                                                	echo "<td>" .  $videos[$i]['date'] . "</td>";
                                                	echo "<td>" .  $videos[$i]['caption'] . "</td>";
                                                	echo "<td>" .  $videos[$i]['url'] . "</td>";
                                                	echo "<td>" .  $status . "</td>";
                                                	echo "<td>" .  anchor(base_url() . "cp/videos/" . $videos[$i]['video_id'],"<i class='pe-7s-search'></i>View") . "</td>";
                                                	echo "</tr>";
                                                }
                                                ?>
                                        </table>
